...
public class Player extends MapObject {
    ...
    public Player(TileMap tm, Camera camera) {
        ...
        vboVertexes = ModelManager.getModel((int)(width* Settings.scaleWidth()),(int)(height* Settings.scaleHeight()));
        if (vboVertexes == -1){
            vboVertexes = ModelManager.createModel((int)(width* Settings.scaleWidth()),(int)(height* Settings.scaleHeight()));
        }
