...
public class Player extends MapObject {
    ...
    public Player(TileMap tm) {
        ...
        try {
            ...
            ByteBuffer spritesheet = new ByteBufferImage(null).decodeImage("Textures\\Sprites\\Player\\oldplayer64.png");
            sprites = new ArrayList<>();
            for(int i = 0; i < 4; i++) {

                int[] images = new int[numFrames[i]];
...
*/
                    //glTexSubImage2D(GL_TEXTURE_2D,0,0,0,32,32,0,GL_RGBA,spritesheet);
                    ...
                    glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA, width*6, height*4, 0, GL_RGBA, GL_UNSIGNED_BYTE, spritesheet);
