...
public class Player extends MapObject {
    ...
    public Player(TileMap tm) {
        ...
        try {
            // getting raw pixels of spritesheet
            ByteBuffer spritesheet = ByteBufferImage.decodeImage("Textures\\Sprites\\Player\\player64.png");
            ...
            for(int i = 0; i < 4; i++) {
                ...
                for(int j = 0; j < numFrames[i]; j++) {
                    ...
                    glTexSubImage2D(GL_TEXTURE_2D,0,j*width,i*height,width,height,GL_RGBA,GL_UNSIGNED_BYTE,subImage);
