...
public class Player extends MapObject {
    ...
    public void update() {
        ...
        if (shooting) {
            ...
            shooting = false;
            double mx =Gamepanel.mouseX/2-xmap;
            double my =Gamepanel.mouseY/2-ymap;
    ...
    public void keyPressed(int key) {
        ...
        if (key == KeyEvent.VK_F1){
            if (Gamepanel.displayCollisions) {
                Gamepanel.displayCollisions = false;
            } else {
                Gamepanel.displayCollisions = true;
            }
        }
    }
