...
*/
    ...
    void entered(){
        ...
        if (type == Room.Classic){
            ...
            int maxMobs = rnd.nextInt(3) + 2;


            for (int i = 0; i < maxMobs;i++){

                int x = getRandom(xMin+tileSize*2,xMax-tileSize*2,rnd);
                int y = getRandom(yMin+tileSize*2,yMax-tileSize*2,rnd);
    ...
    private int getRandom(int lower, int upper, Random rnd) {
