...
public class ArmorBar extends HUD{
    ...
    public ArmorBar(String file, Vector3f pos, int scale, Camera camera){
        ...
        int vbo = ModelManager.createChangingModel(width,height);
        vboVerticesBar = vbo;
    ...
    public void update(int currentArmor, int maxArmor){
        ...
        float deltaArmor = 1 - (float)currentArmor / maxArmor;
            ...
            int[] vertices =
                    {
                            ...
                            width/2-(int)(width*deltaArmor),height/2, // RIGHT TOP
                            width/2-(int)(width*deltaArmor),-height/2 // BOTTOM RIGHT
