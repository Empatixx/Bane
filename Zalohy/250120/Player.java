...
public class Player extends MapObject {
    ...
    //test
    private Spritesheet idLight;
    private int vboLight;
    ...
    public Player(TileMap tm) {
        ...
        idLight = SpritesheetManager.getSpritesheet("Textures\\test.png");
        vboLight = ModelManager.getModel(256,256);
        if (vboLight == -1){
            vboLight = ModelManager.createModel(256,256);
        }
