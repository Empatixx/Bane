...
public class TextRender {
     ...
     */
    public static void renderText(Camera camera, String text,@NotNull Vector3f pos, float scale, @NotNull Vector3f color){
        // resolution scaling
        pos.x *= Settings.scaleWidth();
        pos.y *= Settings.scaleHeight();

        scale*=Settings.scaleWidth();
